...
const checkHoriz = (row: number, col: number, player: string, board: Board, debugBoard: DebugBoard, debug = false) => {
  let cells = []
...
const checkVert = (row: number, col: number, player: string, board: Board, debugBoard: DebugBoard, debug = false) => {
  let cells = []
...
const checkDiagRight = (row: number, col: number, player: string, board: Board, debugBoard: DebugBoard, debug = false) => {
  let cells = []
  for (let i = 3; i > 0; i--) {
...
const checkDiagLeft = (row: number, col: number, player: string, board: Board, debugBoard: DebugBoard, debug = false) => {
  let cells = []
  for (let i = 3; i > 0; i--) {
...
export const checkPositionForWin =
  (row: number, col: number, player: string, board: Board, debugBoard: DebugBoard, debug = false) => {
